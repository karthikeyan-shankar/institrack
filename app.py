...
# Maximum allowed silence between consecutive stops (20s for testing)
route_thresholds = {
...
# Track active bus state: {bus_num: {last_stop, last_stop_index, timestamp}}
active_buses = {}
    ...
    try:
        ...
        if stops and location in stops:
            ...
            if current_stop_index < len(stops) - 1:
                ...
                # Get threshold for this stop pair
